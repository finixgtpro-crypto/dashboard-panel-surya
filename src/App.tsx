...
import { Zap, Activity, Thermometer, Sun, Battery, TrendingUp } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <Header isLive={isLive} onToggleLive={() => setIsLive(v => !v)} key={tick} />
        ...
        <div className="rounded-xl border border-slate-700/60 bg-gradient-to-r from-slate-800 to-slate-800/50 px-6 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            <div className="flex-1">
              <p className="text-xs text-slate-400 uppercase tracking-widest mb-1"></p>
              <p className="text-xs text-slate-400 uppercase tracking-widest mb-1">Penelitian Ilmiah</p>
